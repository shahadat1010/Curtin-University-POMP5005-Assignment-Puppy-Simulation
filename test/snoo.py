...
from animals import Puppy, Human, Squirrel, Toy  # Ensure these classes are defined in animals.py
...
def main():
    ...
    human_name_list = ["Alex", "Joel", "Einstein", "Bro"]
    human_colour_list = ["brown", "brown", "brown", "brown"]
    human_role_list = ["owner", "stranger", "owner", "stranger"]
    human_position_list = [(18, 18), (30, 10), (17, 27), (80, 60)]
    for i in range(4):
        animals.append(Human(human_name_list[i], human_role_list[i], human_colour_list[i], human_position_list[i]))

    squirrel_name_list = ["Rockie", "Micky", "Turkey", "Flocky"]
    squirrel_colour_list = ["lightgreen", "aqua", "crimson", "fuchsia"]
    squirrel_position_list = [(15, 20), (32, 8), (15, 27), (33, 9)]
    for i in range(4):
        animals.append(Squirrel(squirrel_name_list[i], squirrel_colour_list[i], squirrel_position_list[i]))
